...
function moveButton() {
    ...
    // Generate a random duration between 200ms and 300ms
    const randomDuration = Math.random() * 100 + 200; // 200ms to 300ms
    noButton.style.transition = `transform ${randomDuration}ms ease`; // Set the random duration
